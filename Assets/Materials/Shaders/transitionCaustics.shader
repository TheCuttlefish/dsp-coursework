...
////// Emissive:
                float4 node_4152 = _Time;
                float2 node_5890 = float2(i.posWorld.r,i.posWorld.b);
                float2 node_2660 = (_raysscale1*(node_5890+node_4152.g*float2(1,1)));
