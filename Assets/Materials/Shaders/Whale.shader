    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_9142 = (saturate((sin((0.004*((mul(unity_ObjectToWorld, v.vertex).rgb-objPos.rgb).r.r+(node_2469.g*60.0))*6.28318530718))*0.5+0.5))*0.1);
                v.vertex.xyz += float3(node_9142,node_9142,node_9142);
...
////// Emissive:
                float4 node_683 = _Time;
                float2 node_5890 = float2(i.posWorld.r,i.posWorld.b);
                float2 node_2660 = (_raysscale1*(node_5890+node_683.g*float2(1,1)));
