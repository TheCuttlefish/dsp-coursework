...
/////// Diffuse:
                ...
                float node_9818 = 2.0;
                float3 diffuseColor = lerp(_Color.rgb,_Color2.rgb,saturate(floor(max(0,dot(float3(0,1,0),i.normalDir)) * node_9818) / (node_9818 - 1)));
