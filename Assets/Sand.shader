...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:4013,x:32664,y:31859,varname:node_4013,prsc:2|diff-1260-OUT,emission-7871-OUT;n:type:ShaderForge.SFN_Color,id:1304,x:31658,y:31096,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_1304,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Tex2d,id:7782,x:31658,y:30883,ptovrint:False,ptlb:sand,ptin:_sand,varname:node_7782,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:5923db9fd35db9f40858def7d9a26472,ntxv:0,isnm:False|UVIN-911-OUT;n:type:ShaderForge.SFN_Multiply,id:1260,x:32031,y:30963,varname:node_1260,prsc:2|A-7782-RGB,B-1304-RGB;n:type:ShaderForge.SFN_FragmentPosition,id:171,x:29292,y:31457,varname:node_171,prsc:2;n:type:ShaderForge.SFN_Append,id:7262,x:29544,y:31457,varname:node_7262,prsc:2|A-171-X,B-171-Z;n:type:ShaderForge.SFN_Multiply,id:911,x:31398,y:30881,varname:node_911,prsc:2|A-9551-OUT,B-5334-OUT;n:type:ShaderForge.SFN_Slider,id:9551,x:31018,y:30825,ptovrint:False,ptlb:sand scale,ptin:_sandscale,varname:node_9551,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0.001,cur:0.24,max:10;n:type:ShaderForge.SFN_Tex2d,id:1027,x:31714,y:31886,ptovrint:False,ptlb:rays 1,ptin:_rays1,varname:node_1027,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:267f5ec9b21a9d24e8130748651997a5,ntxv:0,isnm:False|UVIN-4171-OUT;n:type:ShaderForge.SFN_Slider,id:817,x:31648,y:31602,ptovrint:False,ptlb:rays alpha,ptin:_raysalpha,varname:node_817,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:2,max:2;n:type:ShaderForge.SFN_Multiply,id:4171,x:31285,y:31882,varname:node_4171,prsc:2|A-127-OUT,B-7983-UVOUT;n:type:ShaderForge.SFN_Slider,id:127,x:30762,y:31764,ptovrint:False,ptlb:rays scale 1,ptin:_raysscale1,varname:node_127,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0.001,cur:0.001,max:0.5;n:type:ShaderForge.SFN_Panner,id:7983,x:30955,y:32035,varname:node_7983,prsc:2,spu:1,spv:1|UVIN-2331-OUT,DIST-416-OUT;n:type:ShaderForge.SFN_Multiply,id:6739,x:30234,y:31861,varname:node_6739,prsc:2|A-6124-T,B-7379-OUT;n:type:ShaderForge.SFN_Slider,id:7379,x:29879,y:31924,ptovrint:False,ptlb:rays speed,ptin:_raysspeed,varname:node_7379,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0.001,cur:1.6,max:20;n:type:ShaderForge.SFN_Get,id:5334,x:31154,y:30917,varname:node_5334,prsc:2|IN-657-OUT;n:type:ShaderForge.SFN_Set,id:657,x:29803,y:31483,varname:worldScale,prsc:2|IN-7262-OUT;n:type:ShaderForge.SFN_Get,id:2331,x:30590,y:32039,varname:node_2331,prsc:2|IN-657-OUT;n:type:ShaderForge.SFN_Time,id:6124,x:30036,y:31780,varname:node_6124,prsc:2;n:type:ShaderForge.SFN_Tex2d,id:6128,x:29713,y:32317,ptovrint:False,ptlb:noise map,ptin:_noisemap,varname:node_6128,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:28c7aad1372ff114b90d330f8a2dd938,ntxv:0,isnm:False|UVIN-202-OUT;n:type:ShaderForge.SFN_Multiply,id:8894,x:30242,y:32341,varname:node_8894,prsc:2|A-6128-R,B-4147-OUT;n:type:ShaderForge.SFN_Slider,id:4147,x:29748,y:32580,ptovrint:False,ptlb:noise amount,ptin:_noiseamount,varname:node_4147,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:10,max:10;n:type:ShaderForge.SFN_Add,id:416,x:30639,y:32164,varname:node_416,prsc:2|A-6739-OUT,B-8894-OUT;n:type:ShaderForge.SFN_TexCoord,id:8925,x:29343,y:32317,varname:node_8925,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Multiply,id:202,x:29531,y:32317,varname:node_202,prsc:2|A-8925-UVOUT,B-359-OUT;n:type:ShaderForge.SFN_Slider,id:359,x:29213,y:32505,ptovrint:False,ptlb:noise scale,ptin:_noisescale,varname:node_359,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.6,max:1;n:type:ShaderForge.SFN_Multiply,id:7871,x:32258,y:31932,varname:node_7871,prsc:2|A-817-OUT,B-1027-A,C-7043-A,D-1931-OUT;n:type:ShaderForge.SFN_Tex2d,id:7043,x:31714,y:32088,ptovrint:False,ptlb:rays 2,ptin:_rays2,varname:node_7043,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:267f5ec9b21a9d24e8130748651997a5,ntxv:0,isnm:False|UVIN-8555-OUT;n:type:ShaderForge.SFN_Multiply,id:8555,x:31379,y:32287,varname:node_8555,prsc:2|A-6045-UVOUT,B-1565-OUT;n:type:ShaderForge.SFN_Slider,id:1565,x:30759,y:32420,ptovrint:False,ptlb:rays scale 2,ptin:_raysscale2,varname:node_1565,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0.001,cur:0.001,max:0.5;n:type:ShaderForge.SFN_Panner,id:6045,x:30966,y:32220,varname:node_6045,prsc:2,spu:0.5,spv:0.5|UVIN-2331-OUT,DIST-416-OUT;n:type:ShaderForge.SFN_Dot,id:1931,x:32258,y:31753,varname:node_1931,prsc:2,dt:1|A-2405-OUT,B-5870-OUT;n:type:ShaderForge.SFN_LightVector,id:2405,x:32058,y:31584,varname:node_2405,prsc:2;n:type:ShaderForge.SFN_NormalVector,id:5870,x:32089,y:31719,prsc:2,pt:False;proporder:7782-1304-9551-6128-359-4147-1027-127-7043-1565-817-7379;pass:END;sub:END;*/

Shader "Shader Forge/Sand" {
    Properties {
        _sand ("sand", 2D) = "white" {}
        _Color ("Color", Color) = (1,1,1,1)
        _sandscale ("sand scale", Range(0.001, 10)) = 0.24
...
/////// Diffuse:
                ...
                float2 node_911 = (_sandscale*worldScale);
                float4 _sand_var = tex2D(_sand,TRANSFORM_TEX(node_911, _sand));
                float3 diffuseColor = (_sand_var.rgb*_Color.rgb);
